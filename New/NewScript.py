...
class Game:
	...
	def __init__(self):
		...
		self.Fort = Biome("Fort", "into a", self.Soil, self.Diamond, self.Iron, self.Raider, self.Minion, self.Zombie, self.Cow, self.Ladder, MobRepellant, "Legendary")
		...
		self.Beach = Biome("Beach", "into a", self.Water, self.Sand, self.Diamond, self.Defender, self.Defender, self.Guardian, self.Fish, None, None, "Uncommon")
		self.Island = Biome("Island", "onto an", self.Water, self.Bone, self.Diamond, self.Defender, self.Guardian, self.Defender, self.Fish, None, None, "Rare")
		self.Shipwreck =Biome("Shipwreck", "into a", self.Water, self.Gold, self.Quartz, self.Defender, self.Guardian, self.Skeleton, self.Fish, self.BottledWave, self.BottledWind, "Legendary")
		...
		self.Canyon = Biome("Canyon", "into a", self.Stone, self.Wood, self.Gold, self.Hunter, self.Hunter, self.Assasin, self.Sheep, None, None, "Uncommon")
		self.Cave = Biome("Cave", "into a", self.Stone, self.Explosive, self.Gold, self.Hunter, self.Assasin, self.Hunter, self.Sheep, None, None, "Rare")
		self.Monument = Biome("Monument", "into a", self.Stone, self.Gold, self.Iron, self.Hunter, self.Assasin, self.Ghoul, self.Sheep, self.Glider, self.Binoculars, "Legendary")
